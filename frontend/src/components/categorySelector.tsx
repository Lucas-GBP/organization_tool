...
export function CategorySelector(props: CategorySelectorProps) {
    ...
    const setItem = useCallback((arg:SelectedCategoryObject) => {
        props.setItem(arg);
        setIsOpen(false);
    }, [props.setItem, setIsOpen])
    ...
    >
        ...
        {isOpen && <div className={style.list}>
...
function Item(props:ItemProps){
    ...
    >
        ...
        {(isExtended && item.sub_categories) && <span 
            className={style.subList}
            onMouseEnter={() => {onSubList.current = true}}
            onMouseLeave={() => {onSubList.current = false}}
            >
